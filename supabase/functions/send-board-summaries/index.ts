...
async function sendSummaryEmail(
  ...
  // Helper function to generate board HTML - optimized for character count
  // Using shorter style values and removing unnecessary attributes
  const generateBoardHtml = (board: BoardActivity) => {
    // Truncate board name if too long to prevent exceeding limit
    const boardName = board.board_name.length > 50 ? board.board_name.substring(0, 47) + '...' : board.board_name;
    return `<table role="presentation" style="width:100%;margin-bottom:20px;border-collapse:separate;background:#fff;border-radius:10px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,.1)"><tr><td style="padding:20px;background:linear-gradient(135deg,#667eea,#764ba2)"><h3 style="margin:0;color:#fff;font-size:18px;font-weight:700">📋 ${boardName}</h3></td></tr><tr><td style="padding:20px"><table role="presentation" style="width:100%;border-collapse:collapse"><tr><td style="padding:0;width:33%"><table role="presentation" style="width:100%;border-collapse:collapse;background:linear-gradient(135deg,#eff6ff,#dbeafe);border-radius:8px;border:2px solid #bfdbfe"><tr><td style="padding:14px 12px;text-align:center"><div style="color:#1e40af;font-size:28px;font-weight:800;margin-bottom:4px;line-height:1.2">${board.message_count}</div><div style="color:#3b82f6;font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:.5px;margin-top:2px">💬 Msgs</div></td></tr></table></td><td style="width:12px;padding:0"></td><td style="padding:0;width:33%"><table role="presentation" style="width:100%;border-collapse:collapse;background:linear-gradient(135deg,#fef2f2,#fee2e2);border-radius:8px;border:2px solid #fecaca"><tr><td style="padding:14px 12px;text-align:center"><div style="color:#dc2626;font-size:28px;font-weight:800;margin-bottom:4px;line-height:1.2">${board.reply_count}</div><div style="color:#ef4444;font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:.5px;margin-top:2px">↩️ Replies</div></td></tr></table></td><td style="width:12px;padding:0"></td><td style="padding:0;width:33%"><table role="presentation" style="width:100%;border-collapse:collapse;background:linear-gradient(135deg,#f0fdf4,#dcfce7);border-radius:8px;border:2px solid #bbf7d0"><tr><td style="padding:14px 12px;text-align:center"><div style="color:#16a34a;font-size:28px;font-weight:800;margin-bottom:4px;line-height:1.2">${board.thread_count}</div><div style="color:#22c55e;font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:.5px;margin-top:2px">✨ Threads</div></td></tr></table></td></tr></table></td></tr></table>`;
  };
